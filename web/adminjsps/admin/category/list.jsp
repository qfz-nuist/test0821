    ...
    <c:forEach items="${categorys }" var="category">
		<tr bordercolor="rgb(78,78,78)">
			...
			<td>
				...
				<a href="<c:url value='/admine/AdmineCategoryServlet?method=editCategory&cid=${category.cid }'/>">修改</a> |
				<%--<a href="<c:url value='/adminjsps/admin/category/del.jsp'/>">删除</a>--%>
				<a href="<c:url value='/admine/AdmineCategoryServlet?method=delegateCategory&cid=${category.cid }'/>">删除</a>
			</td>
		</tr>
